...
dd if=/dev/zero of=disk-datafile-pet-care.img bs=1G count=10
...
losetup -fP disk-datafile-pet-care.img
...
mkfs.ext4 disk-datafile-pet-care.img


echo "7. Creando directorios para usarse como puntos de montaje"
mkdir -p /unam/diplo-bd/pet-care-disks/datafile-pet-care

echo "Listo!"

#mount -o loop /dev/loop3 /unam/diplo-bd/pet-care-disks/datafile-pet-care

#/unam/diplo-bd/pet-care-disk-images/disk-datafile-pet-care.img /unam/diplo-bd/pet-care-disks/datafile-pet-care auto  loop  0 0
